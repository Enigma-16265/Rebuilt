...
public class Elevator extends SubsystemBase
{
    ...
    public Elevator()
    {
        ...
        m_masterMotor.configure(m_elevatorMasterConfig, com.revrobotics.ResetMode.kNoResetSafeParameters, com.revrobotics.PersistMode.kNoPersistParameters);

        m_followerMotor = new SparkFlex(kElevatorFollowerCanId, MotorType.kBrushless);
        m_followerMotor.configure(m_elevatorFollowerConfig, com.revrobotics.ResetMode.kNoResetSafeParameters, com.revrobotics.PersistMode.kNoPersistParameters);
